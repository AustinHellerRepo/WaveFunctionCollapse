...
impl Canvas {
    ...
    fn get_wave_function(&self, source_image_file_path: &str, fragment_width: u32, fragment_height: u32) -> WaveFunction<ImageFragment> {
        ...
        for root_image_fragment in image_fragments.iter() {
            ...
            for width_offset in -(fragment_width as i8 - 1)..(fragment_width as i8) {
                let mut permitted_node_states_per_height_offset: HashMap<i8, Vec<ImageFragment>> = HashMap::new();
                for height_offset in -(fragment_height as i8 - 1)..(fragment_height as i8) {
        ...
        for node_width_index in 0..(self.width - (fragment_width - 1)) as i8 {
            for node_height_index in 0..(self.height - (fragment_height - 1)) as i8 {
                ...
                for neighbor_width_offset in -(fragment_width as i8 - 1)..(fragment_width as i8) as i8 {
                    for neighbor_height_offset in -(fragment_height as i8 - 1)..(fragment_height as i8) as i8 {
...
fn main() {
    todo!("Need to implement the EntropicCollapsableWaveFunction algorithm.");
    ...
    let fragment_width: u32 = 4;
    let fragment_height: u32 = 4;
